...
#Plotting, 
png("plot2.png",height=480,width=480)#Setting the height and width given.
plot(newdata$Global_active_power~newdata$DateAndTime,type = "l",ylab="Global Active Power (kilowatts)",xlab="")#Making the plot.
dev.off()#Making the xlab="" because nothing has to be printed there.
