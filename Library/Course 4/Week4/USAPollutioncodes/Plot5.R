...
png("Plot5.png")
library(ggplot2)
ggplot(plotdata,aes(x=year,y=sum))+geom_point(col="red",cex=2)+labs(x="year",y="Total Emissions in tons")+labs(title="Total Annual Vehicle Emissions in Baltimore City")
dev.off()
